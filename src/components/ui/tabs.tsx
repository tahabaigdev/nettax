...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "ring-offset-background focus-visible:ring-ring data-[state=active]:bg-background inline-flex items-center justify-center px-[1.2rem] text-[2rem] leading-[2.8rem] font-medium whitespace-nowrap text-[#4F4F4F] transition-all hover:text-[#006bff] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-[#006bff]",
        className,
      )}
      {...props}
    />
