  ...
  return (
    <main className="px-[2rem] pt-[13rem] pb-[6rem] xl:px-[0rem]">
      <HelmetSeo
        ...
        url="https://www.nettax.org/nettax.org/privacy-policy"
      />
      ...
      <div className="container flex flex-col gap-[2rem] rounded-[1.2rem] border border-[#cacaca] p-[2rem]">
        <div className="flex flex-col gap-[1rem]">
          ...
          <p className="text-[2.4rem] leading-[4rem] font-light">
            ...
            transparently. This Privacy Policy outlines how we collect, use, and
            safeguard your data in accordance with applicable laws and
            regulations.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-[1rem]">
          ...
          <p className="text-[2.4rem] leading-[4rem] font-light">
            ...
            features. 7. Policy Updates nettax may update this Privacy Policy
            periodically to reflect changes in laws, services, or practices. We
